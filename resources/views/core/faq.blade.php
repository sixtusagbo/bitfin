...
@section('content')
    <section class="page-header hdr-faq">
        <div class="container">
    ...
    <section class="section-sp">
        ...
        <div class="container wow fadeInUp faq-main" style="visibility: visible; animation-name: fadeInUp;">
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-4" aria-expanded="false"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-5" aria-expanded="false"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-6" aria-expanded="false"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-7" aria-expanded="false"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-8" aria-expanded="false"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-9"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-10"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-11"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-12"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-13"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-16"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-17"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-18"
            ...
            <div class="faq-wr">
                <button class="faq-q" type="button" data-toggle="collapse" data-target="#collapse-19"
